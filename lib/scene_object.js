...
class SpriteNode extends SizeNode{
    constructor(spriteHandle_or_list, messageControl=true, trackMouse=false){
        ...
        super(name, null, null, messageControl, trackMouse);
    ...
    update(deltaT){
        ...
        if(this.centerPos){
            const tx = this.centerPos[0] - this.size[0]/2;
            const ty = this.centerPos[1] - this.size[1]/2;
