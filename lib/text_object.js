class TextNode extends SizeNode{
     ...
     * @param {string} name
     * @param {string} text 
     * @param {boolean} message_control 
     * @param {Object.<string, any>|undefined} style 
     */
    constructor(name, text, message_control=true, style){
        super(name, 10, 10, message_control, false)
        ...
        if (style != undefined) {
            for (var key in style) {
                ...
                // save styles in state dict
                this.state[key] = style[key]
            }
        }
