...
Transformer = (function() {
  ...
  Transformer.prototype.pop = function() {
    var ref;
    pop();
    return ref = this.stack.pop(), this.x = ref[0], this.y = ref[1], this.a = ref[2], this.s = ref[3], this.alpha = ref[4], this.tintColor = ref[5], ref;
  };
  ...
  Transformer.prototype.tint = function(c1, c2, c3, alpha){
    console.log("tint called with arguments:",c1, c2, c3, alpha)
    if(alpha!= null){
      this.alpha *= alpha;
    }
    if(c1 && c2 && c3){
